								...
								<li class="has-submenu active">
									...
									<ul class="submenu">
										...
										<li class="has-submenu active">
											...
											<ul class="submenu inner-submenu">
												<li class="active"><a href="search.html">Search Doctor 1</a></li>
										...
										<li class="has-submenu">
											...
											<ul class="submenu inner-submenu">
												...
												<li><a href="booking-popup.html">Booking 2</a></li>
											</ul>
										</li>
					...
					<div class="col-xl-9">
						...
						<div class="row">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-06.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
											<span class="badge bg-orange"><i class="fa-solid fa-star me-1"></i>4.2</span>
											<a href="javascript:void(0)" class="fav-icon">
												<i class="fa fa-heart"></i>
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Robert Thomas</a></h3>
												<div class="d-flex align-items-center">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-07.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Margaret Koller</a></h3>
												<div class="d-flex align-items-center">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-08.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
											<span class="badge bg-orange"><i class="fa-solid fa-star me-1"></i>4.7</span>
											<a href="javascript:void(0)" class="fav-icon">
												<i class="fa fa-heart"></i>
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Cath Busick</a></h3>
												<div class="d-flex align-items-center">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-09.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Travis Barton</a></h3>
												<div class="d-flex align-items-center">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-10.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
											<span class="badge bg-orange"><i class="fa-solid fa-star me-1"></i>5.0</span>
											<a href="javascript:void(0)" class="fav-icon">
												<i class="fa fa-heart"></i>
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Daisy Malcolm</a></h3>
												<div class="d-flex align-items-center">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-11.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Tyrone Patrick</a></h3>
												<div class="d-flex align-items-center">
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<a href="doctor-profile.html"><img src="assets/img/doctor-grid/doctor-grid-12.jpg" alt=""></a>
										<div class="grid-overlay-item d-flex align-items-center justify-content-between">
											<span class="badge bg-orange"><i class="fa-solid fa-star me-1"></i>4.2</span>
											<a href="javascript:void(0)" class="fav-icon">
												<i class="fa fa-heart"></i>
									...
									<div class="card-body p-0">
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1"><a href="doctor-profile.html">Dr. Ann Bell</a></h3>
												<div class="d-flex align-items-center">
													<p class="d-flex align-items-center mb-0 fs-14"><i class="isax isax-location me-2"></i>Minneapolis, MN</p>
													<i class="fa-solid fa-circle fs-5 text-primary mx-2 me-1"></i>
													<span class="fs-14 fw-medium">30 Min</span>
