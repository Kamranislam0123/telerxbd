...
<body>
											...
											<div class="card-body">
												<div class="d-flex align-items-center flex-wrap rpw-gap-2 flex-wrap row-gap-2">
													...
													<div>
														...
														<p class="mb-0 text-muted">Please choose a doctor from <a href="doctors.php">Doctors</a> to book an appointment.</p>
													</div>
													<?php endif; ?>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-7">	
													<div class="card booking-wizard-slots">
														<div class="card-body">
															<?php if (!$doctor): ?>
															<p class="text-muted mb-0">Select a doctor to see available slots.</p>
															<?php else: ?>
															<input type="hidden" id="booking_doctor_id" value="<?php echo (int)$booking_doctor_id; ?>">
															<input type="hidden" id="booking_appointment_date" value="">
															<input type="hidden" id="booking_slot_time" value="">
															<p class="text-muted small mb-2">Select a date on the left, then choose a time slot below.</p>
															<div id="booking-slots-container">
																<p class="text-muted mb-0">Select a date to see available slots.</p>
															</div>
															<?php endif; ?>
														</div>
													</div>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6">
													<div class="mb-3">
														...
														<input type="text" class="form-control" name="booking_full_name" id="booking_full_name" required>
													</div>
												</div>
												<div class="col-lg-6 col-md-6">
													<div class="mb-3">
														<label class="form-label">Mobile Number</label>
														<input type="text" class="form-control" name="booking_mobile" id="booking_mobile" required>
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">Age</label>
														<input type="text" class="form-control" name="booking_age" id="booking_age">
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">Weight</label>
														<input type="text" class="form-control" name="booking_weight" id="booking_weight" placeholder="Kg">
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">Body Temperature</label>
														<input type="text" class="form-control" name="booking_body_temperature" id="booking_body_temperature">
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">Blood Pressure (BP)</label>
														<input type="text" class="form-control" name="booking_blood_pressure" id="booking_blood_pressure">
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">Pulse</label>
														<input type="text" class="form-control" name="booking_pulse" id="booking_pulse">
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">SpO<sub>2</sub></label>
														<input type="text" class="form-control" name="booking_spo2" id="booking_spo2">
													</div>
												</div>
												<div class="col-lg-3 col-md-6">
													<div class="mb-3">
														<label class="form-label">RBS/FBS</label>
														<input type="text" class="form-control" name="booking_rbs_fbs" id="booking_rbs_fbs">
													</div>
												</div>
												<div class="col-lg-12">
													<div class="mb-3">
														<label class="form-label">Symptoms in Details</label>
														<textarea class="form-control" rows="3" name="booking_symptoms" id="booking_symptoms"></textarea>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="mb-3">
														<label class="form-label">Attachment</label>
														<input type="file" class="form-control" name="booking_attachment" id="booking_attachment" accept=".pdf,.jpg,.jpeg,.png">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="card booking-card mb-0">
								...
								<div class="card-footer">
									<div class="d-flex align-items-center flex-wrap rpw-gap-2 justify-content-between">
										...
										<a href="javascript:void(0);" id="booking_confirm_pay_btn" class="btn btn-md btn-primary-gradient next_btns inline-flex align-items-center rounded-pill">
											Confirm & Pay
											<i class="isax isax-arrow-right-3 ms-1"></i>
										</a>
									</div>
											...
											<div class="card flex-fill">
												<div class="card-body d-flex flex-column justify-content-between">
													...
													<div>
														...
														<a href="booking.php" class="btn w-100 btn-md btn-primary-gradient inline-flex align-items-center rounded-pill">
															Start New Booking
														</a>
													</div>
												</div>
	...
	<div id="booking-toast-container" class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 9999;"></div>
